...
public class FeatureGenerator {
	...
	for(int j =0; j<5; j++){
        if (firstName.length()>=j+1){
            feats.add("firstName" + String.valueOf(j)+"="+firstName.charAt(j));
        }
        else{
            feats.add("firstName" + String.valueOf(j)+"="+"!");
        }
        if (lastName.length() >= j+1){
            feats.add("lastName" + String.valueOf(j)+"="+lastName.charAt(j));
        }
        else{
            feats.add("lastName" + String.valueOf(j)+"="+"!");
        }
